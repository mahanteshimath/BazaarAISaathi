...
def analyze_portfolio(df, api_key):
    ...
    for _, row in df.iterrows():
        ...
        prompt = f"""
        Act as an Experienced sucessful/profitable Indian stock market invester. Do Not add any disclaimer that I am not SEBI registered investment advisor or AI generated content. Analyze the following stock from a portfolio and provide a clear recommendation (BUY, SELL, or HOLD).\n
